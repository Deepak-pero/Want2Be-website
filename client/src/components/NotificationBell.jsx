    ...
    const getNotificationMessage = (notification) => {
        switch (notification.type) {
            ...
            case 'share':
                return 'shared your dream';
            case 'dream_share':
                return 'shared a dream with you';
            case 'follow':
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div
                                            ...
                                            onClick={(e) => handleUserProfileClick(notification.sender?._id, e)}
                                        >
                                            {notification.sender?.profilePicture ? (
                                                <img
                                                    src={notification.sender.profilePicture}
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    {/* Share message */}
                                                    {notification.shareMessage && (
                                                        <p className="text-xs text-gray-600 mt-1 bg-blue-50 p-2 rounded-lg italic">
                                                            "{notification.shareMessage}"
                                                        </p>
                                                    )}
                                                    
                                                    {/* Dream preview */}
                                                    {notification.dreamContent && notification.type === 'dream_share' && (
                                                        <p className="text-xs text-gray-500 mt-1 line-clamp-2">
                                                            {notification.dreamContent}...
                                                        </p>
                                                    )}
