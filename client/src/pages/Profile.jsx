...
//             reader.onload = () => {
//                 // Image preview handled by selectedFile state
//             };
...
//         try {
//             // Make API call to like/unlike the dream
//             if (isLiked) {
...
//             // Update local state with the updated dream data
...
//                                     />
//                                 ) : (
//                                     <div className="w-full h-full bg-gradient-to-br from-red-500 to-green-500 flex items-center justify-center text-white text-2xl font-bold">
//                                         {/* {user?.name?.charAt(0)?.toUpperCase() || 'U'} */}
//                                         <img src="../../public/photodemo.png" alt="" />
//                                     </div>
//                                 )}
//                             </div>
//                         </div>
...
//                                     <span className="font-semibold block">{userDreams.length}</span>
...
//                         <p className="text-gray-600 mb-6">Share your first dream to start your journey</p>
//                         <button
//                             onClick={() => navigate('/')}
...
//                 ) : (
//                     <div>
//                         <h2 className="text-xl font-semibold text-gray-900 mb-6">Your Dreams</h2>
//                         <DreamList
//                             dreams={userDreams}
//                             onLike={handleLike}
...
//                                                 <img src="../../public/photodemo.png" alt="user" />
//                                             </div>
//                                         )}
//                                     </div>
//                                     <button
...
//                                         className="absolute -bottom-1 -right-1 w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs border-2 border-white hover:bg-blue-600 transition-colors"
//                                     >
//                                         +
//                                     </button>
//                                     <input
